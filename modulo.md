...
<?xml version="1.0" encoding="utf-8"?>
<odoo>
    <!-- FORMATO DE PÁGINA A4 SIN MÁRGENES (SALIDA / CENTRO DE ACOPIO) -->
    ...
    <!-- PLANTILLA QWEB DEL REPORTE DE SALIDA -->
                ...
                <t t-call="web.external_layout">
                    <div class="page">
                        ...
                        <div class="page-title">
                            MANIFIESTO DE ENTREGA, TRANSPORTE Y RECEPCIÓN DE RESIDUOS PELIGROSOS (CENTRO DE ACOPIO)
                        </div>
                        ...
                        <table class="section-4">
                            ...
                            <tr>
                                <td class="labelcell" colspan="5">
                                    4. Nombre o razón social del centro de acopio: <span t-field="doc.generador_nombre"/>
                                </td>
                            </tr>
                        ...
                        <table>
                            ...
                            <tr>
                                <th colspan="15" class="header-table">5. Identificación de los residuos</th>
                            </tr>
                            <tr>
                                <th class="header-table">Núm. de manifiesto</th>
                                ...
                                <th class="header-table">Cantidad (kg o ton)</th>
                            ...
                            <t t-foreach="doc.residuo_ids" t-as="residuo">
                                <tr>
                                    <!--
                                        En este formato, la columna "Núm. de manifiesto" representa
                                        el número de lote con el que identificas el residuo.
                                        Aquí se asume que la línea tiene acceso al lote por lot_id.
                                    -->
                                    <td class="center-text">
                                        <span t-if="residuo.lot_id" t-field="residuo.lot_id.name"/>
                                    </td>
                                    ...
                                    <td class="center-text"><span t-field="residuo.cantidad"/></td>
                        ...
                        <!-- 7. DECLARACIÓN CENTRO DE ACOPIO -->
                        <table class="signature-section">
                            <tr>
                                <td>
                                    <div class="signature-container">
                                        <div class="signature-text">
                                            7. Declaro bajo protesta de decir verdad que el contenido de este lote está total y correctamente descrito mediante el núm. de manifiesto, nombre del residuo, características CRETIB, debidamente envasado y etiquetado y se han previsto las condiciones de seguridad para su transporte de acuerdo con la legislación vigente.
                                        </div>
                        ...
                        <table>
                            <tr>
                                <td class="labelcell">13. Ruta del centro de acopio hasta su entrega:</td>
                            </tr>
                            <tr>
                                <td style="height: 28px; vertical-align: top;">
                        ...
                        <table class="signature-section">
                            <tr>
                                <td>
                                    <div class="signature-container">
                                        <div class="signature-text">
                                            14. Declaro bajo protesta de decir verdad que recibí los residuos peligrosos descritos en el manifiesto para su transporte a la empresa destinataria señalada por el centro de acopio.
                                        </div>
                                        <div class="signature-fields">
                                            <div class="cell" style="width:40%;">
                                                <strong>Nombre y firma del responsable:</strong><br/>
...
<odoo>
    <record id="view_salida_acopio_form_print_button" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <xpath expr="//header/button[@name='action_view_manifiesto']" position="after">
                        ...
                        <page string="Líneas de Salida">
                            <field name="linea_ids" readonly="state != 'draft'">
                                <list editable="bottom">
                                    ...
                                    <field name="envase_cantidad" optional="hide"/>
                                    <field name="packaging_id" optional="hide"/>
                                    <field name="envase_capacidad" optional="hide"/>
                                    <field name="residue_type" optional="hide"/>
                                </list>
                                <form string="Detalle de Línea de Salida">
                                    <sheet>
                                        <group col="2">
                                            <group string="Producto y Lote">
                                                <field name="producto_id"
                                                       domain="[('type', '!=', 'service')]"
                                                       options="{'no_create': True}"/>
                                                <field name="lote_id"
                                            ...
                                            <group string="Identificación del Residuo">
                                                <field name="nombre_residuo"/>
                                        ...
                                        <group string="Envase" col="4">
                                            <field name="envase_cantidad" string="Unidades"/>
                                            <field name="packaging_id" string="Embalaje"/>
                                            <field name="envase_tipo" string="Tipo (Legacy)"/>
                                            <field name="envase_capacidad"/>
                                        </group>

                                        <group string="Etiquetado" col="2">
            ...
            <form string="Salida de Acopio">
                <div class="alert alert-warning" style="margin-bottom: 20px;">
                    ...
                    <p>
                        ...
                        Al seleccionar un lote, los datos de clasificación y plan de manejo se precargan automáticamente.
                    </p>
                </div>
                ...
                <div class="alert alert-info" style="margin-top: 15px;">
                    <strong>ℹ️ Flujo automatizado:</strong>
                    <ul style="margin: 5px 0;">
                        <li>Al seleccionar un lote, sus datos CRETIB y plan de manejo se precargan automáticamente</li>
                        <li>Los datos capturados aquí se propagan al manifiesto de salida Y al historial de movimientos</li>
                        <li>El manifiesto generado quedará en estado "Confirmado" listo para completar datos administrativos</li>
                        <li>Se crea automáticamente el movimiento de inventario de egreso</li>
                    </ul>
                </div>
